 ...
 * @date 2018年1月29日 上午11:13:31
 */
@Controller
@RequestMapping("/auto/apiData")
public class APIDataController extends BaseController {

	@Resource
	private IAPIDataService apiDataService;

	private static final Logger logger = Logger.getLogger(APIDataController.class);
	...
	public String list(HttpServletRequest request) {
		try {
			...
			return apiDataService.list(pageIndex,pageSize,projectName);
